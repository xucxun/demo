...
<table cellspacing="20px" style="height:350px;">
	...
	<tr>
		...
		<a href="javascript:publishBlog()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">修改博客</a></td>
	</tr>
</table>
</div>
<script type="text/javascript">
	...
	var ue = UE.getEditor("editor",{
		initialFrameHeight:175,//设置编辑器高度
	});
	ue.addListener("ready",function(){
		//通过ajax请求数据
		UE.ajax.request("${pageContext.request.contextPath}/admin/blog/selectById.do",
			{
				method:"post",
				asyc:false,
				data:{"id":"${param.id}"},

   ...
   var url;
	...
	function deleteComment(){
		...
		if(selectedRows.length==0){
			$.messager.alert("系统提示","请至少选择一条要删除的评论");
			return;
		}
		//声明一个数组装选中评论的id
		var ToRemoveId=[];
		...
		$.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条评论吗？",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/admin/comment/deleteComment.do",{ids:ids},function(result){
					if(result.success){
